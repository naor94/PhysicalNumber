...
//         }
//         if(type.compare("km")==0)u=Unit::KM;
//         else if(type.compare("m")==0)u=Unit::M;
//         else if(type.compare("cm")==0)u=Unit::CM;
//         else if(type.compare("ton")==0)u=Unit::TON;
//         else if(type.compare("kg")==0)u=Unit::KG;
//         else if(type.compare("g")==0)u=Unit::G;
//         else if(type.compare("hour")==0)u=Unit::HOUR;
//         else if(type.compare("min")==0)u=Unit::MIN;
//         else if(type.compare("sec")==0)u=Unit::SEC;
//         else{
//         auto errorState = is.rdstate(); // remember error state
//         is.clear(); // clear error so seekg will work
//         is.seekg(startPosition); // rewind
